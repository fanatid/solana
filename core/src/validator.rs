...
use {
    ...
    solana_rpc::{
        ...
        rpc_service::{ClientOption, GetAccountsStateConfig, JsonRpcService, JsonRpcServiceConfig},
...
impl Default for ValidatorConfig {
    fn default() -> Self {
        Self {
            ...
            get_accounts_state_config: None,
        ...
        *start_progress.write().unwrap() = ValidatorStartProgress::StartingServices;
        ...
        let (
            ...
            let rpc_svc_config = JsonRpcServiceConfig {
                ...
                get_accounts_state_config: config.get_accounts_state_config,
